function main() {
    ...
    null;
    undefined;
}//создать html файл, скопировать из тайпскрипт а потом вставлять в дажва скрипт и соединить дажава скрипт и html. Если будут проблемы, написать в тг @kudlatskaya и возможно проблема будет решена