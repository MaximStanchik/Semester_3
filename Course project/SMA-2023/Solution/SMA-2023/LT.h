...
namespace LT	//ТАБЛИЦА ЛЕКСЕМ
{
	enum operations {
		NOT = -1,// Отрицание 
		PLUSOPER,// Операция сложения 
		MINUSOPER,// Операция вычитания
		MULOPER,// Операция умножения
		DIVOPER,// Операция деления 
		DIVMODOPER,// Операция деления с остатком
		MOREOPER,// Операция "больше"
		LESSOPER,// Операция "меньше"
		EQUOPER,// Операция "равно"
		NEQUOPER    // Операция "не равно"
	};
